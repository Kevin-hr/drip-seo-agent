...
public static class V44SnapshotCompleteness
{
    ...
    public static SnapshotCompleteness Evaluate(ProductSnapshot snapshot)
    {
        ...
        var fields = new List<SnapshotFieldStatus>
        {
            ...
            Field("current_sku", false, null, "no reader in the stack"),
            Field("supplier_code", false, null, "no reader in the stack"),
            Field("category", false, null, "no reader in the stack"),
            Field("price", false, null, "no reader in the stack"),
            Field("inventory", false, null, "no reader in the stack"),
            Field("variants", false, Variants, "no reader in the stack"),
